package com.fintech.ternaku.Main.TambahData.Kesuburan.InjeksiHormon;
...
public class AdapterListProtokolInjeksi extends BaseAdapter implements Filterable {
    private ArrayList<ModelAddProtokolInjeksi> mOriginalValues; // Original Values
    private ArrayList<ModelAddProtokolInjeksi> mDisplayedValues;    // Values to be displayed
    LayoutInflater inflater;

    public AdapterListProtokolInjeksi(Context context, ArrayList<ModelAddProtokolInjeksi> mProtocolModelArrayList) {
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint,FilterResults results) {
                ...
                mDisplayedValues = (ArrayList<ModelAddProtokolInjeksi>) results.values; // has the filtered values
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                ArrayList<ModelAddProtokolInjeksi> FilteredArrList = new ArrayList<ModelAddProtokolInjeksi>();

                if (mOriginalValues == null) {
                    mOriginalValues = new ArrayList<ModelAddProtokolInjeksi>(mDisplayedValues); // saves the original data in mOriginalValues
                }
